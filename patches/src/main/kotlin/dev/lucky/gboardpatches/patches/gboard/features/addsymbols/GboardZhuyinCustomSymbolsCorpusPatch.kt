...
import dev.lucky.gboardpatches.patches.gboard.shared.indexOfFirstMoveResultAfter
import dev.lucky.gboardpatches.patches.gboard.shared.methodCallIndices
...
private fun buildCorpusAppendDelegate(register: Int): String = """
    invoke-static {v$register}, Ldev/lucky/gboardpatches/extension/addsymbols/GboardAddSymbolsRuntime;->appendCustomCorpusItem(Ljava/lang/Object;)Ljava/lang/Object;
