...
import dev.lucky.gboardpatches.patches.gboard.shared.instructionIndices
import dev.lucky.gboardpatches.patches.gboard.shared.indexOfFirstFieldAccess
...
private val CONSTRUCTOR_DELEGATE = """
    invoke-static {p0, p5}, Ldev/lucky/gboardpatches/extension/addsymbols/GboardAddSymbolsRuntime;->onEmoticonKeyboardConstructed(Ljava/lang/Object;Ljava/lang/Object;)V
""".trimIndent()

private val BODY_READY_DELEGATE = """
    invoke-static {p0}, Ldev/lucky/gboardpatches/extension/addsymbols/GboardAddSymbolsRuntime;->onEmoticonBodyReady(Ljava/lang/Object;)V
""".trimIndent()

private val CATEGORY_NAME_LOOKUP_DELEGATE = """
    invoke-static {p0, p1}, Ldev/lucky/gboardpatches/extension/addsymbols/GboardAddSymbolsRuntime;->overrideCategoryNameFromIndex(Ljava/lang/Object;I)Ljava/lang/String;
...
private val SELECTED_INDEX_DELEGATE = """
    invoke-static {p0, p1}, Ldev/lucky/gboardpatches/extension/addsymbols/GboardAddSymbolsRuntime;->resolveSelectedCategoryIndex(Ljava/lang/Object;Ljava/lang/Object;)I
...
private val CATEGORY_CHANGE_DELEGATE = """
    invoke-static {p0, p1, p2}, Ldev/lucky/gboardpatches/extension/addsymbols/GboardAddSymbolsRuntime;->handleCategoryChange(Ljava/lang/Object;II)Z
...
private val CATEGORY_BIND_DELEGATE = """
    invoke-static {p0, p1, p2}, Ldev/lucky/gboardpatches/extension/addsymbols/GboardAddSymbolsRuntime;->handleCategoryBind(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/String;)Z
...
private val HEADER_CALLBACK_DELEGATE = """
    invoke-static {}, Ldev/lucky/gboardpatches/extension/addsymbols/GboardAddSymbolsRuntime;->onHeaderCallbackAfter()V
""".trimIndent()

private val HEADER_CALLBACK_BEFORE_DELEGATE = """
    invoke-static {p0}, Ldev/lucky/gboardpatches/extension/addsymbols/GboardAddSymbolsRuntime;->onHeaderCallbackBefore(Ljava/lang/Object;)V
""".trimIndent()

private val HEADER_START_EDGE_GUARD_DELEGATE = """
    invoke-static {p0}, Ldev/lucky/gboardpatches/extension/addsymbols/GboardAddSymbolsRuntime;->shouldSkipHeaderStartEdgeUpdate(Ljava/lang/Object;)Z
...
private val VIEW_UTIL_TRANSFORM_GUARD_DELEGATE = """
    invoke-static {p0, p1, p2}, Ldev/lucky/gboardpatches/extension/addsymbols/GboardAddSymbolsRuntime;->shouldSkipDetachedViewTransform(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)Z
