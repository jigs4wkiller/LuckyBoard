...
private val ITEM_CLICK_DELEGATE = """
    invoke-static/range {p0 .. p0}, Ldev/lucky/gboardpatches/extension/addsymbols/GboardAddSymbolsRuntime;->onEmoticonItemClick(Ljava/lang/Object;)V
""".trimIndent()

private val HISTORY_WRITE_DELEGATE = """
    invoke-static {p0, p1}, Ldev/lucky/gboardpatches/extension/addsymbols/GboardAddSymbolsRuntime;->interceptHistoryWrite(Ljava/lang/Object;Ljava/lang/String;)Z
